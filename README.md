...
## Train
Download the [UCMerced dataset](http://weegee.vision.ucmerced.edu/datasets/landuse.html) and split it into train/val/test data, where the original images would be taken as the HR references and the corresponding LR images are generated by bicubic down-sample. 
```
# x4
